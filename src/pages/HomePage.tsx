...
const heroHighlights = [
  '100+ premium studio locations across Bangalore',
      ...
      <main className="bg-gradient-to-b from-white via-purple-50/20 to-pink-50/20">
        <section className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:py-28">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-600">
              At Spin Salon, we offer a wide range of services tailored to meet your every beauty and
              grooming need. From haircuts and styling to skincare, makeup, and wellness treatments,
              our curated offerings are designed to leave you looking and feeling fabulous. Discover
              the perfect blend of expertise, luxury, and personalized care in every service we provide.
            </p>
          </div>
        ...
        <section className="mx-auto mt-20 max-w-7xl px-6 py-20 sm:px-10">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-600">
              At Spin Unisex Salon, our clients are at the heart of everything we do. Each experience
              is crafted with care, precision, and passion, leaving our clients feeling confident and
              radiant. But don&apos;t just take our word for it—here&apos;s what our valued clients have to
          ...
          <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 via-pink-500 to-rose-400 px-10 py-16 text-white shadow-2xl lg:px-20 lg:py-20">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-3xl text-lg text-rose-100">
                ...
                industry, Spin Unisex Salon has grown into a symbol of excellence, innovation, and care.
                Starting with a single salon in Bangalore in 2011, we have expanded our reach across
                South India, creating a network of over 55+ centers that redefine beauty and wellness.
              </p>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 text-sm">
                <a
                  href="https://www.instagram.com/spinsalonbellandur?igsh=aWUxZmRpdTZqYTY%3D&utm_source=qr"
